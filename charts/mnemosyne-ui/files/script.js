...
if (savedMnemosyneUrl && (savedMnemosyneUrl.includes('.local') || savedMnemosyneUrl.includes('api-mnemosyne') || savedMnemosyneUrl.includes('localhost') || savedMnemosyneUrl.includes('127.0.0.1'))) {
